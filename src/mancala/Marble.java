...
public class Marble {
	...
	/**
	 * @description Splits the primary image (mancalaImages.png) into separate images used for the 
	 * wooden Mancala board and each of the marble images. These images are resized from the original
